...
class PyRemoteResolve(object):
    def Fusion(self) -> "PyRemoteFusion": ...
...
class PyRemoteProject(object):
    ...
    def StartRendering(self, jobids: Optional[List[str]] = ..., isInteractiveMode: bool = ...) -> bool: ...
    ...
    def GetRenderResolutions(self, format: Optional[str] = ..., codec: Optional[str] = ...) -> List[Dict[Any, Any]]: ...
...
class PyRemoteMediaStorage(object):
    ...
    def AddClipMattesToMediaPool(self, MediaPoolItem: "PyRemoteMediaPoolItem", paths: List[Any], stereoEye: str) -> bool: ...
...
class PyRemoteMediaPool(object):
    ...
    def AppendToTimeline(self, clips: List["PyRemoteMediaPoolItem"]) -> List["PyRemoteTimelineItem"]: ...
    def CreateTimelineFromClips(self, name: str, clips: List["PyRemoteMediaPoolItem"]) -> "PyRemoteTimeline": ...
    def ImportTimelineFromFile(self, filePath: str, options: Optional[Dict[Any, Any]] = ...) -> "PyRemoteTimeline": ...
    ...
    def MoveClips(self, clips: List["PyRemoteMediaPoolItem"], targetFolder: "PyRemoteFolder") -> bool: ...
    def MoveFolders(self, folder: List["PyRemoteFolder"], targetFolder: "PyRemoteFolder") -> bool: ...
    ...
    def DeleteClipMattes(self, MediaPoolItem: "PyRemoteMediaPoolItem", paths: List[str]) -> bool: ...
    ...
    def ExportMetadata(self, fileName: str, clips: Optional[List["PyRemoteMediaPoolItem"]] = ...) -> bool: ...
...
class PyRemoteMediaPoolItem(object):
    ...
    def AddMarker(self, frameid: int, color: str, name: str, note: str, duration: int, customData: str) -> bool: ...
...
class PyRemoteTimeline(object):
    ...
    def DeleteMarkerAtFrame(self, frameNum: int) -> bool: ...
    def DeleteMarkerByCustomData(self, customData: str) -> bool: ...
    def ApplyGradeFromDRX(self, path: str, gradeMode: int, items: List["PyRemoteTimelineItem"]) -> bool: ...
    ...
    def DeleteClips(self, clips: List["PyRemoteTimelineItem"], ripple: bool = False) -> bool: ...
    def CreateCompoundClip(self, items: List["PyRemoteTimelineItem"], clipinfo: Optional[Dict[Any, Any]] = ...) -> "PyRemoteTimelineItem": ...
    ...
    def Export(self, fileName: str, exportType: float, exportSubtype: Optional[float] = ...) -> bool: ...
    def GetSetting(self, settingName: Optional[Union[str, Dict[Any, Any]]] = ...) -> Dict[Any, Any]: ...
    def SetSetting(self, settingName: str, settingValue: Union[str, float, int, Dict[Any, Any]]) -> bool: ...
...
class PyRemoteFusion(object): ...


class PyRemoteComposition(object): ...


class PyRemoteOperator(object): ...
